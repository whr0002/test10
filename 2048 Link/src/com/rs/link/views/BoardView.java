...
public class BoardView extends View {
	...
	public BoardView(Context context, AttributeSet atts) {
		...
		loadBitmaps(1, r.getDrawable(R.drawable.n2_fixed1));
		loadBitmaps(2, r.getDrawable(R.drawable.n4_fixed1));
		loadBitmaps(3, r.getDrawable(R.drawable.n8_fixed1));
		loadBitmaps(4, r.getDrawable(R.drawable.n16_fixed1));
		loadBitmaps(5, r.getDrawable(R.drawable.n32_fixed1));
		loadBitmaps(6, r.getDrawable(R.drawable.n64_fixed1));
		loadBitmaps(7, r.getDrawable(R.drawable.n128_fixed1));
		loadBitmaps(8, r.getDrawable(R.drawable.n256_fixed1));
		loadBitmaps(9, r.getDrawable(R.drawable.n512_fixed1));
		loadBitmaps(10, r.getDrawable(R.drawable.n1024_fixed1));
		loadBitmaps(11, r.getDrawable(R.drawable.n2048_fixed1));
